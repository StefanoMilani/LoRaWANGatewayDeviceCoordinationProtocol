...
uint16_t UDPSegment::getSrcPort() const
{
    return this->srcPort;
}

void UDPSegment::setSrcPort(uint16_t srcPort)
{
    this->srcPort = srcPort;
}

uint16_t UDPSegment::getDestPort() const
{
    return this->destPort;
}

void UDPSegment::setDestPort(uint16_t destPort)
{
    this->destPort = destPort;
}

uint16_t UDPSegment::getLength() const
{
    return this->length;
}

void UDPSegment::setLength(uint16_t length)
{
    this->length = length;
}

uint16_t UDPSegment::getChecksum() const
{
    return this->checksum;
}

void UDPSegment::setChecksum(uint16_t checksum)
{
