...
/**
 * Class generated from <tt>src/LoRaFrames/LoRaDatalinkFrame.msg:1</tt> by opp_msgtool.
 * <pre>
...
template<> inline LoRaDatalinkFrame *fromAnyPtr(any_ptr ptr) { return check_and_cast<LoRaDatalinkFrame*>(ptr.get<cObject>()); }
