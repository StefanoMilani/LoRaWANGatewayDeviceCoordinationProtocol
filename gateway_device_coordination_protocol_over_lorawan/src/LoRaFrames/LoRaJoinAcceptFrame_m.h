...
/**
 * Class generated from <tt>src/LoRaFrames/LoRaJoinAcceptFrame.msg:1</tt> by opp_msgtool.
 * <pre>
...
template<> inline LoRaJoinAcceptFrame *fromAnyPtr(any_ptr ptr) { return check_and_cast<LoRaJoinAcceptFrame*>(ptr.get<cObject>()); }
