...
/**
 * Class generated from <tt>src/LoRaFrames/LoRaPhysicalFrame.msg:1</tt> by opp_msgtool.
 * <pre>
...
template<> inline LoRaPhysicalFrame *fromAnyPtr(any_ptr ptr) { return check_and_cast<LoRaPhysicalFrame*>(ptr.get<cObject>()); }
