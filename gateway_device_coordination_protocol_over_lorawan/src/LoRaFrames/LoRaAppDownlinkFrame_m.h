...
/**
 * Struct generated from src/LoRaFrames/LoRaAppDownlinkFrame.msg:1 by opp_msgtool.
 */
struct LoRaControlDownlink
{
    LoRaControlDownlink();
...
/**
 * Class generated from <tt>src/LoRaFrames/LoRaAppDownlinkFrame.msg:14</tt> by opp_msgtool.
 * <pre>
...
inline any_ptr toAnyPtr(const LoRaControlDownlink *p) {return any_ptr(p);}
template<> inline LoRaControlDownlink *fromAnyPtr(any_ptr ptr) { return ptr.get<LoRaControlDownlink>(); }
template<> inline LoRaAppDownlinkFrame *fromAnyPtr(any_ptr ptr) { return check_and_cast<LoRaAppDownlinkFrame*>(ptr.get<cObject>()); }
